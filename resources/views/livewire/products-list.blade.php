            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-4">
                        ...
                        <x-button wire:click="export('csv')">CSV</x-button>
                        <x-button wire:click="export('xlsx')">XLSX</x-button>
                        <x-button wire:click="export('pdf')">PDF</x-button>
                    </div>
                        ...
                        <table class="min-w-full border divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left bg-gray-50">
                                        <span wire:click="sortByColumn('countryName')" class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">Country</span>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                                @foreach($products as $product)
                                    <tr class="bg-white">
                                        ...
                                        <td>
                                            <a href="{{ route('products.edit', $product->id) }}" class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase bg-gray-800 rounded-md border border-transparent hover:bg-gray-700">
                                                Edit
                                            </a>
